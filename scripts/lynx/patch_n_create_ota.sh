...
# - lynx_OTA - Where required files for Custota OTA server to run are generated by this script
...
mkdir -p ${DEVICE_DIR}/pre-installation
...
python ${AVBROOT_DIR}/avbroot.py \
	...
	--directory ${DEVICE_DIR}/pre-installation
}
...
${CUSTOTA_DIR}/custota-tool \
	gen-update-info \
	--file ${DEVICE_DIR}/${DEVICE_CODENAME}.json \
